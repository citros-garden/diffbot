...
: ${AMENT_CURRENT_PREFIX:="/workspaces/diffbot/ros2_ws/install/diffbot_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/diffbot_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/diffbot_bringup/environment/path.sh"
