...
hardware_interface::return_type ros2_control_demo_mydiffbot ::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(
  ros2_control_demo_mydiffbot::DiffBotSystemHardware, hardware_interface::SystemInterface)
